...
| `--te-auto-schedule` | `off` | relative_warmup 指標で Text Encoder の学習率を自動減衰し、必要なら凍結まで行う。ログは 200 step ごとにまとめて書き出し。 | 使い方とプリセットは [docs/te_auto_schedule.md](docs/te_auto_schedule.md) を参照。|
