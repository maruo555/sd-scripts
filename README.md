...
| `--te-auto-schedule` | `off` | EMA ベースの plateau 検出で Text Encoder の LR を自動減衰／凍結。ログは 200 step ごとにまとめて書き出し。 | 使い方とプリセットは [docs/te_auto_schedule.md](docs/te_auto_schedule.md) を参照。|
